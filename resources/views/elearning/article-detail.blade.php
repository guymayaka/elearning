...
@section('title')
    elearning -  {{ $article->title }}
@endsection

@section('page_seo')
    <meta name="description" content="{{ Str::limit($article->resume, 100, '...') }}">
    ...
    <meta property="og:description" content="{{ Str::limit($article->resume, 100, '...') }}" />
    <meta property="og:image" content="{{ FrontEnd::image($article->image, 'recent-article') }}" />

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="elearning.com">
    <meta name="twitter:title" content="{{ $article->title }}">
    <meta name="twitter:description" content="{{ Str::limit($article->resume, 100, '...') }}">
    <meta name="twitter:creator" content="@creator_username">
    <meta name="twitter:image" content="{{ FrontEnd::image($article->image, 'recent-article') }}">
    <meta name="twitter:domain" content="{{ request()->getHttpHost() }}">
@endsection


@section('body')
    @include('elearning.layouts.partials.body.body-article-detail')
@stop
