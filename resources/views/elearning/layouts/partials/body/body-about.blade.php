<div class="contact-section2">
    <div class="container">
        ...
        <div class="row mt-5 text-center">
           <h2 class="text-white">Qui nous sommes</h2>
        </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="circle-container">
                <img src="{{ asset('elearning/assets/img/front-view-formal-male-journalist.jpg') }}" class="img-cover" alt="" srcset="">
            </div>
        </div>
        <div class="col-lg-6">
            ...
            <p>
                ...
                Sur initiative et management de l'Ingénieur <strong>Jacques BOKUNGU</strong>, ce site a été dévéloppé pour aider nos populations à s'informer en temps réel sur l'actualité du pays et du monde.

            </p>
            <a href="{{ route('elearning.contact.index') }}" class="btn btn-primary">Nous contacter</a>
        </div>
    </div>
</div>
